...
func (m *MockUserRepository) GetByID(ctx context.Context, id int64) (data.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetByUsername(ctx context.Context, username string) (data.User, error) {
	m.ctrl.T.Helper()
